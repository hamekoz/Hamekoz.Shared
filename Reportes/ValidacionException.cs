...
namespace Hamekoz.Reportes
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="T:ValidacionException"/> class
		/// </summary>
		...
		protected ValidacionException (System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base (info, context)
		{
		}
	}
}
